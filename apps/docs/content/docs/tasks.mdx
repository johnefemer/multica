...
The Agenthost server scans every 30 seconds. Two kinds of timeout trigger a failure:
...
**Retryable** (Agenthost automatically requeues):
...
```bash
agenthost issue rerun <issue-id>
```
