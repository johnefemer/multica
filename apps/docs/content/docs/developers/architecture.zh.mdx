---
title: Architecture
description: Technical architecture of the Agenthost platform.
---

## Overview

Agenthost is a Go backend + monorepo frontend (pnpm workspaces + Turborepo) with shared packages.
...
- **Entry points** (`cmd/`): `server` (HTTP API), `agenthost` (CLI + daemon), `migrate`
