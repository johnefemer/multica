...
export const metadata: Metadata = {
  title: "Download Agenthost",
  description:
    "Download Agenthost for macOS, Windows, or Linux — or install the CLI for servers and remote dev boxes.",
  openGraph: {
    title: "Download Agenthost",
    description:
      "Get the Agenthost desktop app with a bundled daemon, or install the CLI for servers and remote dev boxes.",
    url: "/download",
  },
  alternates: {
    canonical: "/download",
