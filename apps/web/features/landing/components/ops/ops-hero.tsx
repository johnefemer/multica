    ...
    <header className="relative overflow-hidden border-b border-[var(--line2)] py-[var(--hero-pad-y-md-top)] pb-[var(--hero-pad-y-md-bot)] sm:pt-[var(--hero-pad-y-top)] sm:pb-[var(--hero-pad-y-bot)]">
      <OpsContainer>
        <div className="grid grid-cols-1 gap-10 max-[1020px]:grid-cols-1 lg:grid-cols-[1.5fr_1fr]">
          <div>
            <div className="mb-8 flex flex-wrap items-center gap-[14px] text-[var(--font-size-label)] tracking-[var(--tr-label)] text-[var(--accent)] before:content-['//'] before:text-[var(--dim)]">
            ...
            <h1 className="m-0 mb-6 break-words text-[var(--font-size-hero-md)] font-[var(--weight-bold)] uppercase leading-[0.96] tracking-[var(--tr-headline)] text-[var(--txt)] max-[380px]:text-[var(--font-size-hero-sm)] max-[1020px]:text-[var(--font-size-hero-lg)] sm:mb-8 sm:text-[var(--font-size-hero-md)] lg:text-[var(--font-size-hero)]">
              {hero.headlineLine1}
              <br />
              {hero.headlineLine2Pre}
              <span className="font-[var(--weight-medium)] text-[var(--accent)]">
            ...
            <p className="m-0 mb-9 max-w-[54ch] text-[var(--font-size-lede)] leading-[var(--lh-loose)] text-[var(--txt2)]">
              {hero.ledeIntro}
              <b className="font-[var(--weight-medium)] text-[var(--txt)]">
                {hero.ledeBold}
              </b>
              {hero.ledeMid}
            ...
            <div className="mb-9 flex flex-wrap items-center gap-[10px]">
              ...
              <span className="ml-[6px] text-[var(--font-size-micro)] tracking-[var(--tr-caps)] text-[var(--dim)]">
                {hero.ctaMeta}
              </span>
            </div>
            ...
            <div className="grid grid-cols-2 border border-[var(--line2)] sm:grid-cols-4">
              {(
                ...
                >
                  <div className="mb-2 text-[var(--font-size-nano-sm)] tracking-[var(--tr-eyebrow)] text-[var(--dim)]">
                    {cell.k}
                  </div>
                  <div className="text-[var(--font-size-metric)] font-[var(--weight-bold)] tracking-[-0.02em] text-[var(--txt)]">
                    {cell.v}
                    {cell.vSuffix ? (
                      <small className="ml-1 text-[11px] font-[var(--weight-medium)] text-[var(--accent)]">
                        {cell.vSuffix}
                      </small>
                    ) : null}
                  </div>
                  <div className="mt-1 text-[var(--font-size-micro)] tracking-[0.04em] text-[var(--dim)]">
                    {cell.n}
                  </div>
                </div>
              ))}
