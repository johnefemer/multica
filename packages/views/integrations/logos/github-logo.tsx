// GitHub Invertocat mark — official SVG path (98×96 viewBox).
// Uses currentColor so it renders white on dark backgrounds and
// black on light backgrounds, matching the two PNG assets provided.
