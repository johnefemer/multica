// Backup of the pre-redesign Welcome step (Direction A+B responsive
// rewrite, 2026-05-05). Not imported anywhere — git history is the
// authoritative source. Safe to delete once the new design is validated.
"use client";
