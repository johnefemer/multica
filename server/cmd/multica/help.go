...
var rootHelpTemplate = `Work seamlessly with Agenthost from the command line.

USAGE
  agenthost <command> <subcommand> [flags]
{{range .Groups}}
{{.Title}}
...
LEARN MORE
  Use ` + "`agenthost <command> <subcommand> --help`" + ` for more information about a command.
`
