...
func init() {
	...
	rootCmd.SetVersionTemplate("agenthost {{.Version}}\n")
	...
	rootCmd.PersistentFlags().String("server-url", "", "Agenthost server URL (env: AGENTHOST_SERVER_URL)")
	rootCmd.PersistentFlags().String("workspace-id", "", "Workspace ID (env: AGENTHOST_WORKSPACE_ID)")
