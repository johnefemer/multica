...
const defaultCLIConfigPath = ".agenthost/config.json"
...
func CLIConfigPathForProfile(profile string) (string, error) {
	...
	return filepath.Join(home, ".agenthost", "profiles", profile, "config.json"), nil
}
...
func ProfileDir(profile string) (string, error) {
	...
	if profile == "" {
		return filepath.Join(home, ".agenthost"), nil
	}
	return filepath.Join(home, ".agenthost", "profiles", profile), nil
}
